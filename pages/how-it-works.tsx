    ...
    <main className="min-h-screen bg-gray-950 text-gray-100">
      ...
      <div className="bg-gray-950 border-b border-gray-800">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
          <Link href="/automate" className="text-sm font-semibold text-gray-400 hover:text-green-400 transition-colors flex items-center gap-2">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-4">You keep using email and text. Nothing changes on your end.</h2>
        ...
        {/* Section 2 */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-4">The AI part: reading messages so you don&apos;t have to dig through them.</h2>
          <p className="text-gray-400 leading-relaxed mb-4">
          ...
          <div className="bg-gray-900 rounded-xl p-6 border border-gray-800 mb-4">
            ...
            <p className="text-gray-300 italic mb-6">&quot;Hey, need a quote for a backyard cleanup — maybe 2000 sq ft, nothing urgent.&quot;</p>
        ...
        {/* Section 3 */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-4">It drafts your reply. You approve it.</h2>
          <p className="text-gray-400 leading-relaxed mb-4">
            Based on what the customer asked, the system writes a first draft of your reply. Something like:
          </p>
          <div className="bg-green-950 border border-green-800 rounded-xl p-6 mb-4">
            <div className="text-sm font-semibold text-green-400 uppercase mb-3">Draft reply ready for review:</div>
        ...
        {/* Section 4 */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-4">Automatic follow-ups, reminders, and status updates.</h2>
          <p className="text-gray-400 leading-relaxed mb-4">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={text} className="flex items-start gap-4 p-4 rounded-lg border border-gray-800 bg-gray-900">
                <div className="text-green-400 w-5 text-center mt-0.5"><i className={`fas ${icon}`}></i></div>
        ...
        {/* Section 5 */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-white mb-4">What the AI is not doing.</h2>
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={text} className="flex items-start gap-4 p-4 rounded-lg border border-gray-800">
                <div className="text-gray-600 w-5 text-center mt-0.5"><i className="fas fa-minus"></i></div>
                <p className="text-gray-300">{text}</p>
              </div>
            ))}
          </div>
        ...
        <section className="text-center pt-8 border-t border-gray-800">
          <h2 className="text-2xl font-bold text-white mb-4">Ready to see what this looks like for your business?</h2>
          <p className="text-gray-400 mb-8">Every business is different. A 20-minute conversation is usually enough to identify the highest-value automation opportunity.</p>
          <a
            href="mailto:michael@mcgraw.io?subject=automate"
